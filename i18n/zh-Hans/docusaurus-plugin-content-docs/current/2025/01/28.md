...
### [反应](https://news.ycombinator.com/item?id=42845488)
...
“在 Go 1.24 中引入的“go tool”引发了关于其对依赖管理影响的争论，人们担心合并工具和项目依赖可能导致冲突。” “批评者提出了替代方案，例如使用单独的模块文件或使用像 Nix 这样的工具来改进版本控制。” “Go 的支持者认为，这种方法提供了简单性和有效性，反映了编程语言中依赖管理的更广泛挑战。”
